...
// Add a new function to clear all of the issues from the list
function clearAllIssues() {
  localStorage.removeItem('issues');
  fetchIssues();
}

// Add a button to the page that calls the clearAllIssues() function
var clearAllButton = document.createElement('button');
clearAllButton.textContent = 'Clear All Issues';
clearAllButton.addEventListener('click', clearAllIssues);
document.querySelector('body').appendChild(clearAllButton);

// Developed by t surya teja